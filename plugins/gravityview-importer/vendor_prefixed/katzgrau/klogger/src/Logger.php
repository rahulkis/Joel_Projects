 ...
 * @license MIT
 *
 * Modified by The GravityKit Team on 17-April-2023 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
namespace GravityKit\GravityImport\Katzgrau\KLogger;

use DateTime;
use RuntimeException;
use GravityKit\GravityImport\Psr\Log\AbstractLogger;
 ...
 *
 * Usage:
 * $log = new GravityKit\GravityImport\Katzgrau\KLogger\Logger('/var/log/', GravityKit\GravityImport\Psr\Log\LogLevel::INFO);
