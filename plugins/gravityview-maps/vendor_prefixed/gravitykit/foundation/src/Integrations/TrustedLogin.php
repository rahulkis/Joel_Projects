...
class TrustedLogin {
	...
	public function get_config() {
		...
		$capabilities = apply_filters( 'gk/foundation/integrations/trustedlogin/capabilities', [
			'add'    => [
				'gravityview_full_access' => esc_html__( 'We need access to Views to provide great support.', 'gk-gravitymaps' ),
				'gform_full_access'       => esc_html__( 'We will need to see and edit the forms, entries, and Gravity Forms settings to debug issues.', 'gk-gravitymaps' ),
				'install_plugins'         => esc_html__( 'We may need to manage plugins in order to debug conflicts on your site and add related GravityView functionality.', 'gk-gravitymaps' ),
				'update_plugins'          => '',
				'deactivate_plugins'      => '',
				'activate_plugins'        => '',
			],
			'remove' => [
				'manage_woocommerce' => strtr(
					esc_html_x( "We don't need to see your [plugin] details to provide support (if [plugin] is enabled).", 'Placeholders inside [] are not to be translated.', 'gk-gravitymaps' ),
					[ 'plugin' => 'WooCommerce' ]
				),
