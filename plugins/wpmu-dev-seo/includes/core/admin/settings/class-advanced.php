...
class Advanced extends Admin_Settings {
	...
	public function options_page() {
		...
		$image_url = sprintf( '%s/assets/images/graphic-autolinking-disabled.svg', SMARTCRAWL_PLUGIN_URL );
	...
	private function get_breadcrumb_options() {
		...
		return array(
			...
			array(
				...
				'snippets'    => array(),
				'value'       => isset( $options['labels']['archive'] ) ? $options['labels']['archive'] : __( 'Archives for', 'wds' ),
				'placeholder' => __( 'Archives for', 'wds' ),
				'variables'   => array_merge(
