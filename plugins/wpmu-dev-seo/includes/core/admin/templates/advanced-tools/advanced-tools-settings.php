...
<div id="container" class="<?php \smartcrawl_wrap_class( 'wds-page-autolinks' ); ?>">
	...
	<?php if ( $disable_adv_tools ) : ?>
		...
		$this->render_view(
			'disabled-component',
			array(
				'content'      => esc_html__( 'Enhance website SEO with advanced tools. Access Smarcrawl\'s impressive features including automatic linking, URL redirection, robots.txt editor, Moz reporting, and Breadcrumbs.', 'wds' ),
