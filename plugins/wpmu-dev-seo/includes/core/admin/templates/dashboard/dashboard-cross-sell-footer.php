...
<div class="sui-cross-sell-bottom">
	...
	<img
		class="sui-image"
		src="<?php echo esc_attr( SMARTCRAWL_PLUGIN_URL ); ?>/assets/images/dev-team.png"
		srcset="<?php echo esc_attr( SMARTCRAWL_PLUGIN_URL ); ?>/assets/images/dev-team@2x.png 2x"
		alt="<?php esc_html_e( 'Unlock now with Pro', 'wds' ); ?>">
</div>