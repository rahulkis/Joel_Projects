...
class Global_IP extends Component {
	...
	/**
	 * Set 2 weeks reminder for dashboard notice when welcome modal is closed.
	 *
	 * @return void
	 */
	public function set_dashboard_notice_reminder(): void {
		update_site_option( self::DASHBOARD_NOTICE_REMINDER, time() + (2 * WEEK_IN_SECONDS) );
	}
