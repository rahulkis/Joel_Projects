...
/*
    ...
    @fs_premium_only /inc/mobile-app/,/inc/websocket.php,/addons/calls.php,/addons/calls-group.php,/inc/mini.php,/assets/js/bp-messages-premium.min.js,/assets/js/bp-messages-premium.min.js.LICENSE.txt,/assets/sounds/calling.mp3,/assets/sounds/calling.ogg,/assets/sounds/dialing.mp3,/assets/sounds/dialing.ogg
*/
        ...
        public function get_script_variables()
        {
            ...
            if ( bpbm_fs()->is__premium_only() ) {
                ...
                if ( $this->realtime ) {
                    ...
                    $script_variables['EPN'] = apply_filters( 'better_messages_push_active', Better_Messages()->settings['enablePushNotifications'] === '1' );
                    
                    if ( apply_filters( 'better_messages_3rd_party_push_active', false ) ) {
                        $script_variables['EPN'] = '1';
                    ...
                    $script_variables['callQuality'] = $this->settings['callQuality'];
                    ...
                    if ( $this->settings['encryptionEnabled'] === '1' ) {
                        ...
                        if ( is_user_logged_in() ) {
                            $script_variables['ukey'] = $this->websocket->get_user_secret_key( get_current_user_id() );
                        }
                    }
