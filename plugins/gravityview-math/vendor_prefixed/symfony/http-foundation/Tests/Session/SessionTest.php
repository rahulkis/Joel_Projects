...
namespace GravityKit\GravityMath\Symfony\Component\HttpFoundation\Tests\Session;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag;
use GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\Flash\FlashBag;
use GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\Session;
use GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
use GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
{
    /**
     * @var \GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityMath\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityMath\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
