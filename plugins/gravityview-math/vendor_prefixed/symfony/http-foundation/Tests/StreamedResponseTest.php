...
use GravityKit\GravityMath\Symfony\Component\HttpFoundation\StreamedResponse;
...
class StreamedResponseTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityMath\Symfony\Component\HttpFoundation\StreamedResponse', $response);
    ...
    public function testReturnThis()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityMath\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());
        $this->assertInstanceOf('GravityKit\GravityMath\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());

        $response = new StreamedResponse(function () {});
        $this->assertInstanceOf('GravityKit\GravityMath\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
        $this->assertInstanceOf('GravityKit\GravityMath\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
    }
