...
namespace GravityKit\GravityMath\Symfony\Component\Finder\Tests;
...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityMath\Symfony\Component\Finder\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityMath\\Symfony\\Component\\Finder\\Finder', Finder::create()->append([]));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                ...
                $expectedExceptionClass = 'GravityKit\\GravityMath\\Symfony\\Component\\Finder\\Exception\\AccessDeniedException';
