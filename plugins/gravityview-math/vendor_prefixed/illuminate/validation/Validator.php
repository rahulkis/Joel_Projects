...
use GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\Arr;
use GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\Str;
use GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\Fluent;
use GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\MessageBag;
use GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Container\Container;
use GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator;
use GravityKit\GravityMath\Symfony\Component\HttpFoundation\File\UploadedFile;
use GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Container\Container
     */
    protected $container;
     ...
     *
     * @var \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return void
     *
     * @throws \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Validation\ValidationException
     */
     ...
     *
     * @return \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @param  \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Contracts\Container\Container  $container
     * @return void
     */
