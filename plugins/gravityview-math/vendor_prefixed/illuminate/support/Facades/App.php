 ...
 * @method static \GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\ServiceProvider register(\GravityKit\GravityMath\Foundation\ThirdParty\Illuminate\Support\ServiceProvider|string $provider, array $options = [], bool $force = false)
