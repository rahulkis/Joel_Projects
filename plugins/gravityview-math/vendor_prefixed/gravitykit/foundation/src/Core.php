...
namespace GravityKit\GravityMath\Foundation;

use GravityKit\GravityMath\Foundation\Integrations\GravityForms;
use GravityKit\GravityMath\Foundation\Integrations\HelpScout;
use GravityKit\GravityMath\Foundation\Integrations\TrustedLogin;
use GravityKit\GravityMath\Foundation\WP\AdminMenu;
use GravityKit\GravityMath\Foundation\Logger\Framework as LoggerFramework;
use GravityKit\GravityMath\Foundation\WP\AjaxRouter;
use GravityKit\GravityMath\Foundation\WP\PluginActivationHandler;
...
use GravityKit\GravityMath\Foundation\Translations\Framework as TranslationsFramework;
use GravityKit\GravityMath\Foundation\Encryption\Encryption;
use GravityKit\GravityMath\Foundation\Helpers\Core as CoreHelpers;
use GravityKit\GravityMath\Foundation\Helpers\Arr;
use GravityKit\GravityMath\Foundation\WP\RESTController;
...
HTML;
				...
				$general_settings = array_merge(
					...
					[
						[
							...
							'title'       => esc_html__( 'Display "Powered By" Link', 'gk-gravitymath' ),
							'description' => esc_html__( 'A "Powered by GravityKit" link will be displayed below some GravityKit products. Help us spread the word!', 'gk-gravitymath' ),
						],
						[
							'id'          => 'affiliate_id',
							'type'        => 'number',
							'value'       => Arr::get( $gk_settings, 'affiliate_id' ),
							'title'       => esc_html__( 'Affiliate ID', 'gk-gravitymath' ),
							'description' => strtr(
								esc_html_x( 'Earn money when people clicking your links become GravityKit customers. [link]Register as an affiliate[/link]!', 'Placeholders inside [] are not to be translated.', 'gk-gravitymath' ),
								[
						...
						[
							...
							'title'       => esc_html__( 'Become a Beta Tester', 'gk-gravitymath' ),
							'description' => esc_html__( 'You will have early access to the latest GravityKit products. There may be bugs! If you encounter an issue, report it to help make GravityKit products better!', 'gk-gravitymath' ),
						],
					]
				);
				...
				$support_settings = [
					[
						...
						'title'       => esc_html__( 'Support Email', 'gk-gravitymath' ),
						'description' => esc_html__( 'In order to provide responses to your support requests, please provide your email address.', 'gk-gravitymath' ),
						'validation'  => [
							[
								'rule'    => 'required',
								'message' => esc_html__( 'Support email is required', 'gk-gravitymath' ),
							],
							[
								'rule'    => 'email',
								'message' => esc_html__( 'Please provide a valid email address', 'gk-gravitymath' ),
							],
						],
					],
					[
						...
						'title'       => esc_html__( 'Show Support Port', 'gk-gravitymath' ),
						'description' => ( esc_html__( 'The Support Port provides quick access to how-to articles and tutorials. For administrators, it also makes it easy to contact support.', 'gk-gravitymath' ) .
						                   strtr(
							                   esc_html_x( '[image]Support Port icon[/image]', 'Placeholders inside [] are not to be translated.', 'gk-gravitymath' ),
							                   [
				...
				$technical_settings = [
					[
						...
						'title'       => esc_html__( 'Enable No-Conflict Mode', 'gk-gravitymath' ),
						'description' => esc_html__( 'No-conflict mode prevents extraneous scripts and styles from being printed on GravityKit admin pages, reducing conflicts with other plugins and themes.', 'gk-gravitymath' ),
					],
				];
				...
				$all_settings = [
					self::ID => [
						...
						'sections' => [
							[
								'title'    => esc_html__( 'General', 'gk-gravitymath' ),
								'settings' => $general_settings,
							],
							[
								'title'    => esc_html__( 'Support', 'gk-gravitymath' ),
								'settings' => $support_settings,
							],
							[
								'title'    => esc_html__( 'Technical', 'gk-gravitymath' ),
